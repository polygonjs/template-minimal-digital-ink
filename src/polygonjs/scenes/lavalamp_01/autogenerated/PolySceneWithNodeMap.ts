...
export class PolySceneWithNodeMap_lavalamp_01 extends PolyScene {
  ...
  node(path: "/lavalamp/material3"): MaterialSopNode;
  node(path: "/lavalamp/box1"): BoxSopNode;
  node(path: "/lavalamp/MAT"): MaterialsNetworkSopNode;
  node(path: "/lavalamp/MAT/rayMarchingBuilder1"): RayMarchingBuilderMatNode;
  node(path: "/lavalamp/COP"): CopNetworkSopNode;
  node(path: "/lavalamp/COP/imageEXR_envMap"): ImageEXRCopNode;
  node(path: "/lavalamp/actor1"): ActorSopNode;
  node(path: "/lavalamp/actor1/onTick1"): OnTickActorNode;
  node(path: "/lavalamp/actor1/rayFromCursor1"): RayFromCursorActorNode;
  node(path: "/lavalamp/actor1/rayIntersectPlane1"): RayIntersectPlaneActorNode;
  node(path: "/lavalamp/actor1/plane1"): PlaneActorNode;
  node(
    path: "/lavalamp/actor1/setMaterialUniform1"
  ): SetMaterialUniformActorNode;
  node(
    path: "/lavalamp/actor1/setMaterialUniform2"
  ): SetMaterialUniformActorNode;
  node(
    path: "/lavalamp/actor1/setMaterialUniform3"
  ): SetMaterialUniformActorNode;
...
export interface PolySceneProps_lavalamp_01 {
  ...
  "lavalamp-material3--group"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-material3--assignMat"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-material3--material"?: ParamValueSerializedTypeMap["node_path"];
  "lavalamp-material3--applyToChildren"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-material3--cloneMat"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-material3--shareCustomUniforms"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-material3--swapCurrentTex"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-material3--texSrc0"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-material3--texDest0"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-box1--size"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--sizes"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-box1--sizes-sizesx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--sizes-sizesy"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--sizes-sizesz"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--sizesx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--sizesy"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--sizesz"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--divisions"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-box1--center"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-box1--center-centerx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--center-centery"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--center-centerz"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--centerx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--centery"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-box1--centerz"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--default"?: ParamValueSerializedTypeMap["folder"];
  "lavalamp-MAT-rayMarchingBuilder1--maxSteps"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-MAT-rayMarchingBuilder1--maxDist"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--surfDist"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--advanced"?: ParamValueSerializedTypeMap["folder"];
  "lavalamp-MAT-rayMarchingBuilder1--setBuilderNode"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-MAT-rayMarchingBuilder1--builderNode"?: ParamValueSerializedTypeMap["node_path"];
  "lavalamp-MAT-rayMarchingBuilder1--envTexture1"?: ParamValueSerializedTypeMap["node_path"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1-pos1x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1-pos1y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1-pos1z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos1z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2-pos2x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2-pos2y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2-pos2z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos2z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3-pos3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3-pos3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3-pos3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-MAT-rayMarchingBuilder1--pos3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--url"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-COP-imageEXR_envMap--reload"?: ParamValueSerializedTypeMap["button"];
  "lavalamp-COP-imageEXR_envMap--tencoding"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--encoding"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--tmapping"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--mapping"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--twrap"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--wrapS"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--wrapT"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--tminFilter"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--minFilter"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--tmagFilter"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--magFilter"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--tanisotropy"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--useRendererMaxAnisotropy"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--anisotropy"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--tflipY"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--flipY"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--ttransform"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--offset"?: ParamValueSerializedTypeMap["vector2"];
  "lavalamp-COP-imageEXR_envMap--offset-offsetx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--offset-offsety"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--offsetx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--offsety"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--repeat"?: ParamValueSerializedTypeMap["vector2"];
  "lavalamp-COP-imageEXR_envMap--repeat-repeatx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--repeat-repeaty"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--repeatx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--repeaty"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--rotation"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--center"?: ParamValueSerializedTypeMap["vector2"];
  "lavalamp-COP-imageEXR_envMap--center-centerx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--center-centery"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--centerx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--centery"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-COP-imageEXR_envMap--tadvanced"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--tformat"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--format"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--ttype"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-COP-imageEXR_envMap--type"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-COP-imageEXR_envMap--checkFileType"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-actor1--useThisNode"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-actor1--node"?: ParamValueSerializedTypeMap["node_path"];
  "lavalamp-actor1-rayFromCursor1--element"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-actor1-plane1--normal"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-actor1-plane1--normal-normalx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-plane1--normal-normaly"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-plane1--normal-normalz"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-plane1--normalx"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-plane1--normaly"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-plane1--normalz"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-plane1--constant"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--addPrefix"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-actor1-setMaterialUniform1--name"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-actor1-setMaterialUniform1--type"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-actor1-setMaterialUniform1--lerp"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--Vector3"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-actor1-setMaterialUniform1--Vector3-Vector3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--Vector3-Vector3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--Vector3-Vector3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--Vector3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--Vector3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform1--Vector3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--addPrefix"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-actor1-setMaterialUniform2--name"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-actor1-setMaterialUniform2--type"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-actor1-setMaterialUniform2--lerp"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--Vector3"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-actor1-setMaterialUniform2--Vector3-Vector3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--Vector3-Vector3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--Vector3-Vector3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--Vector3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--Vector3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform2--Vector3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--addPrefix"?: ParamValueSerializedTypeMap["boolean"];
  "lavalamp-actor1-setMaterialUniform3--name"?: ParamValueSerializedTypeMap["string"];
  "lavalamp-actor1-setMaterialUniform3--type"?: ParamValueSerializedTypeMap["integer"];
  "lavalamp-actor1-setMaterialUniform3--lerp"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--Vector3"?: ParamValueSerializedTypeMap["vector3"];
  "lavalamp-actor1-setMaterialUniform3--Vector3-Vector3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--Vector3-Vector3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--Vector3-Vector3z"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--Vector3x"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--Vector3y"?: ParamValueSerializedTypeMap["float"];
  "lavalamp-actor1-setMaterialUniform3--Vector3z"?: ParamValueSerializedTypeMap["float"];
